 ...
 * @author sjl
 */
public class HotSchemePagerAdapter extends PagerAdapter implements View.OnTouchListener {
    ...
    public HotSchemePagerAdapter(Context context, List<ListBean> hotSchemeList) {
