 ...
 * @author sjl
 */
public class PlantSelectAdapter extends PagerAdapter {
    ...
    public PlantSelectAdapter(Context context, List<ListBean> plantList) {
        mContext = context;
    ...
    @Override
    public int getCount() {
        return mPlantList == null ? 0 : mPlantList.size();
    }
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        imageView.setOnLongClickListener(v -> {
            ...
            if (null != onItemLongClickListener) {
                onItemLongClickListener.onPlantViewPagerItemLongClick(position);
            }
            return false;
        });
//        imageView.setBackgroundResource(R.drawable.bg_border);
        ListBean listBean = mPlantList.get(position);
    ...
    */
    ...
    public interface OnItemLongClickListener {
         ...
         */
        void onPlantViewPagerItemLongClick(int position);
    }
