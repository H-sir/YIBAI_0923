 ...
 */
public class RecommendedPotAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecommendedPotAdapter(Context context, List<ListBean> recommendedPotList) {
        this.mContext = context;
        this.mRecommendedPotList = recommendedPotList;
    ...
    public int getItemCount() {
        return mRecommendedPotList == null ? 0 : mRecommendedPotList.size();
    }
    ...
    public void onSelectStateChanged(int position) {
        for (int i = 0; i < mRecommendedPotList.size(); i++) {
            ListBean listBean = mRecommendedPotList.get(i);
            if (i == position) {
        ...
        onItemClickListener.onPotItemClick(position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onPotItemClick(int position);
    }
