 ...
 * @author sjl
 */
public class ScenePopupMenu implements View.OnTouchListener {
    ...
    */
    ...
    public static ScenePopupMenu getInstance() {
        return new ScenePopupMenu();
    }

    private void createView(Context context) {
        mRootVew = LayoutInflater.from(context).inflate(R.layout.scene_popup_menu_layout, null);
    ...
    private void initData(Context context) {
        height = DensityUtil.dpToPx(context, 240);
