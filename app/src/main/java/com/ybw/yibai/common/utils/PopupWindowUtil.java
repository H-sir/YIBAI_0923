...
public class PopupWindowUtil {
    ...
    public void setCreateDefaultDialogListener(CreateDefaultDialogListener createDefaultDialogListener) {
        this.createDefaultDialogListener = createDefaultDialogListener;
    }

    public interface CreateDefaultDialogListener {
        void onCreateDefaultDialog(Boolean isCancel);
    }
}
