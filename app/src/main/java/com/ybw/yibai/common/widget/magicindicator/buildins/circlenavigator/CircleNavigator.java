package com.ybw.yibai.common.widget.magicindicator.buildins.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void init(Context context) {
        ...
        mRadius = Util.dipToPx(context, 3);
        mCircleSpacing = Util.dipToPx(context, 8);
        mStrokeWidth = Util.dipToPx(context, 1);
    }
