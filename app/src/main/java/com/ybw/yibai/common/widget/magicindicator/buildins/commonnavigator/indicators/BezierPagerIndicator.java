...
import com.ybw.yibai.common.widget.magicindicator.buildins.ArgbEvaluatorHolder;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = Util.dipToPx(context, 3.5);
        mMinCircleRadius = Util.dipToPx(context, 2);
        mYOffset = Util.dipToPx(context, 1.5);
    }
