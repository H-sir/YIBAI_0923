...
/**
 * 修改绑定的手机号码Presenter实现类
 *
 * @author sjl
 */
public class BindingPhonePresenterImpl extends BasePresenterImpl<BindingPhoneView> implements BindingPhonePresenter, CallBack {
     ...
     */
    private BindingPhoneView mBindingPhoneView;
     ...
     * @param view View的对象
     */
    public BindingPhonePresenterImpl(BindingPhoneView view) {
        super(view);

        // 调用父类的方法获取View的对象
        this.mBindingPhoneView = getView();
        mBindingPhoneModel = new BindingPhoneModelImpl();
    }
    ...
    public void getVerificationCode(TextView getVerificationCodeTextView, String phoneNumber) {
        Activity activity = (Activity) mBindingPhoneView;
        ...
        // 获取验证码
        mBindingPhoneModel.getVerificationCode(phoneNumber, this);
    ...
    public void onGetVerificationCodeSuccess(VerificationCode verificationCode) {
        mBindingPhoneView.onGetVerificationCodeSuccess(verificationCode);
     ...
     */
    @Override
    public void bindingPhone(String phoneNumber, String verificationCode) {
        Activity activity = (Activity) mBindingPhoneView;
        if (!NetworkStateUtil.isNetworkAvailable(activity)) {
            // 没有网络
            MessageUtil.showNoNetwork();
        ...
        mBindingPhoneModel.bindingPhone(phoneNumber, verificationCode, this);
    }
    ...
    public void onBindingPhoneSuccess(BindingPhone bindingPhone) {
        mBindingPhoneView.onBindingPhoneSuccess(bindingPhone);
    }
}
