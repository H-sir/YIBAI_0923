...
public class CustomerListActivity extends BaseActivity implements View.OnClickListener {
    ...
    */
    ...
    protected void initData() {
        ...
        mTitleList.add(getResources().getString(R.string.in_the_quotation));
        mTitleList.add(getResources().getString(R.string.to_follow_up));
        ...
        for (int i = 0; i < mTitleList.size(); i++) {
            fragment[i] = new CustomerListFragment();
