 ...
 * @date 2019/12/2
 */
public class HotSchemesActivity extends BaseActivity implements View.OnClickListener {
    ...
    */
    ...
    protected int setLayout() {
        ...
        return R.layout.activity_hot_schemes;
    }
    ...
    protected void initEvent() {
        ...
        for (int i = 0; i < mHotSchemeList.size(); i++) {
            ...
            fragment[i] = new HotSchemesFragment();
