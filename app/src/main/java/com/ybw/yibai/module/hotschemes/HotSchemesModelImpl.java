 ...
 * @date 2019/12/2
 */
public class HotSchemesModelImpl implements HotSchemesModel {

    public final String TAG = "HotSchemesModelImpl";
     ...
     */
    @Override
    public void saveSimulationData(ListBean plantBean, Bitmap bitmap, CallBack callBack) {
        int width = 0;
        int height = 0;
    ...
    public void saveSimulationData(ListBean plantBean, ListBean potBean, Bitmap bitmap, CallBack callBack) {
        ...
        int augmentedCombinationType = potBean.getComtype();
        String augmentedPriceCode = potBean.getPrice_code();
        String augmentedTradePriceCode = potBean.getTrade_price_code();
