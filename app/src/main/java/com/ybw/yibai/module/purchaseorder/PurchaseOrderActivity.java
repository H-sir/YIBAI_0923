...
public class PurchaseOrderActivity extends BaseActivity implements View.OnClickListener {
    ...
    */
    ...
    protected void initData() {
        ...
        mTitleList.add(getResources().getString(R.string.pending_payment));
        mTitleList.add(getResources().getString(R.string.pending_delivery));
        mTitleList.add(getResources().getString(R.string.pending_receipt));
        mTitleList.add(getResources().getString(R.string.completed));

        initMagicIndicator();

        Fragment[] fragment = new Fragment[mTitleList.size()];
        for (int i = 0; i < mTitleList.size(); i++) {
            fragment[i] = new PurchaseOrderFragment();
